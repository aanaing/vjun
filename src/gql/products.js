...
export const PRODUCTS = gql`
  query Products(
    ...
    $offset: Int!
    $search: String
    $sorting_created_at: order_by
    $amount: order_by
  ) {
    products(
      limit: $limit
      offset: $offset
      order_by: { created_at: $sorting_created_at, sold_amount: $amount }
      where: {
        _or: [{ name: { _ilike: $search } }, { barcode: { _ilike: $search } }]
      }
    ) {
      created_at
      description
...
export const CREATE_PRODUCT_VARIATION = gql`
  mutation Insert_Product_Variations_One(
    $name: String!
    $image_url: String!
    $price: numeric!
    $product_id: uuid!
...
export const UPDATE_PRODUCT_VARIATION = gql`
  mutation Update_Product_Variation_By_Id(
    $id: uuid!
    $color: String
    $price: numeric
    $image_url: String
...
export const CREATE_PRODUCT_PHOTO = gql`
  mutation Insert_Product_Photos($image_url: String!, $id: uuid!) {
    insert_product_photos_one(
      object: { product_image_url: $image_url, fk_product_id: $id }
    ) {
      id
    }
  }
