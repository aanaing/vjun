      ...
      >
        <TableContainer sx={{ maxHeight: "60vh" }}>
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                <TableCell style={{ minWidth: 60 }}>Name</TableCell>
                <TableCell style={{ minWidth: 60 }}>Photo</TableCell>
                <TableCell style={{ minWidth: 70 }}>Address</TableCell>
                <TableCell style={{ minWidth: 100 }}>Map Link</TableCell>
                <TableCell style={{ minWidth: 60 }}>Phone</TableCell>
                <TableCell style={{ minWidth: 100 }}>Note</TableCell>
              ...
              {shops?.map((row) => {
                return (
                  <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                    ...
                    <TableCell>{row.map_link}</TableCell>
